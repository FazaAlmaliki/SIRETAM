    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    echo "<tr bgcolor='#f5f5f5'><th rowspan='15' width='110px'><center><img style='border:1px solid #cecece; height:85px; width:85px' src='".base_url()."asset/foto_user/$foto_user' class='img-circle img-thumbnail'></center></th></tr>
              ...
              <div class='box-footer'>
                    ...
                    <a href='".base_url().$this->uri->segment(1)."/konsumen'><button type='button' class='btn btn-default pull-right'>Batal</button></a>
