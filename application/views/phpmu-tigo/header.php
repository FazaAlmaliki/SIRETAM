	...
	<div class='header-menu'>
		<div class='header-search'>
			".form_open('produk/index')."
				<input type='text' placeholder='Cari Item Disini..'' name='kata' class='search-input' required/>
		...
		<span class='city'>
          ...
          if ($this->session->id_konsumen != ''){
            ...
            echo "<a class='hidden-xs' href='".base_url()."members/orders_report'>Status Transaksi</a> &nbsp; &nbsp; 
            	  ...
            	  <a class='btn btn-xs btn-success' style='padding:1px 12px' href='".base_url()."members/profile'>Akun</a> 
