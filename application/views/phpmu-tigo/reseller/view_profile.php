<?php 
echo "<p class='sidebar-title text-danger produk-title'> Data Profil Anda 
        <a class='btn btn-success btn-xs pull-right' href='".base_url()."members/edit_profile'><span class='glyphicon glyphicon-edit'></span> Edit Profil</a></p>";
        echo $this->session->flashdata('message'); 
        $this->session->unset_userdata('message');
        echo "<p>Berikut Informasi Data Profil Anda.<br> 
...
echo "<table id='example11' class='table table-hover table-condensed'>
  ...
  <tbody>";
      ...
      echo "<tr><td>$no</td>
                <td><a href='".base_url()."members/detail_reseller/$row[id_supplier]'><small><b>$row[nama_supplier]</b></small><br><small class='text-success'>$row[kode_transaksi]</small></a></td>
                ...
                <td>$proses <br><small>$row[nama_supplier]</small></td>
