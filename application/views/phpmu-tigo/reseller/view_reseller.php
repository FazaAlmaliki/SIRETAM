    ...
    echo "<div class='col-md-2 col-xs-6' style='margin-bottom:20px'>
              ...
              if($this->session->level=='konsumen'){ $akses = 'members'; }else{ $akses = 'produk'; }
                if ($this->session->produk == ''){
                  echo "<a class='btn btn-info btn-xs' title='Detail Data' href='".base_url()."$akses/detail_reseller/$row[id_reseller]'><span class='glyphicon glyphicon-user'></span> Profil</a>
                  ...
                  echo "<a style='width:60px' class='btn btn-info btn-xs' title='Detail Data' href='".base_url()."$akses/detail_reseller/$row[id_reseller]'><span class='glyphicon glyphicon-user'></span> Profil</a>
