...
echo "<li style='margin-bottom:none' class='list-group-item'>Pengguna Online <span class='badge'>$pengunjungonline</span></li>
	<li style='margin-bottom:none' class='list-group-item'>Kunjungan Hari Ini <span class='badge'>$pengunjung</span></li>
